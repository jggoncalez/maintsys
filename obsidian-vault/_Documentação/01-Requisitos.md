...
| **RNF-7**  | Disponibilidade: Uptime >99.5%                             | Infra        | **C**      |
...
A manutenção de máquinas industriais é crítica para operações. 
Atualmente:
...
- [[09-Metodologia]] — Workflow, padrões e implementação
