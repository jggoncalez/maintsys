...
2. [[02-Arquitetura]] — design
3. [[Arquitetura-Tecnica]] — stack
4. [[08-Diagrama-ER]] — dados
```
...
2. [[DIAGRAMAS]] — todos os fluxos
3. [[07-Checklist]] — cases de teste
4. Executar testes!
```
...
2. ✅ Explore [[DIAGRAMAS]] para entender fluxos
3. ✅ Estude [[03-Banco-de-Dados]] antes de codar

### Implementação
1. ✅ Siga [[07-Checklist]] fase por fase
2. ✅ Use [[Quick-Reference]] para snippets
...
### Documentação Chave
- **Comece aqui:** [[README]] → [[CANVAS]]
- **Entenda projeto:** [[01-Requisitos]] + [[02-Arquitetura]]
- **Implemente:** [[07-Checklist]] + [[Quick-Reference]]
...
Depois siga:
1. [[01-Requisitos]] — Entenda o quê
2. [[02-Arquitetura]] — Entenda como
3. [[07-Checklist]] — Execute passo-a-passo
4. [[Quick-Reference]] — Use snippets
5. [[DIAGRAMAS]] — Consulte conforme precisa

---

## 📞 Suporte Rápido

- **Qual é o objetivo?** → [[01-Requisitos]]
- **Como funciona?** → [[CANVAS]] → [[DIAGRAMAS]]
- **Por onde começo?** → [[07-Checklist]]
- **Tenho um erro?** → [[Fluxo-*]] relevante
- **Preciso de código?** → [[Quick-Reference]]
- **Qual é a arquitetura?** → [[Arquitetura-Tecnica]]
