...
- [[DIAGRAMAS]] — Índice de todos os flowcharts e diagramas

### 📚 **Documentação Completa**
- [[ESTRUTURA]] — Estrutura de documentação e navegação
...
| Documento | Conteúdo |
|-----------|----------|
| [[01-Requisitos]] | RF, RNF, contexto do projeto |
| [[02-Arquitetura]] | Stack, fluxos, RBAC pattern |
| [[Arquitetura-Tecnica]] | Camadas, componentes, integrações |

### 2️⃣ **Banco de Dados**
| Documento | Conteúdo |
|-----------|----------|
| [[03-Banco-de-Dados]] | Schema SQL, migrations, índices |
| [[08-Diagrama-ER]] | Mermaid ER, relacionamentos, queries |

### 3️⃣ **Filament & UI**
| Documento | Conteúdo |
|-----------|----------|
| [[04-Filament-Resources]] | Resources, forms, relation managers |
| [[05-Dashboard]] | Widgets, stats, real-time updates |

### 4️⃣ **Segurança & Acesso**
| Documento | Conteúdo |
|-----------|----------|
| [[06-Permissões]] | Spatie RBAC, 4 roles, policies |
...
| Documento | Conteúdo |
|-----------|----------|
| [[07-Checklist]] | 7 fases, 100+ tarefas, testes |
...
### 👤 Você é **Arquiteto**?
```
Leia: [[02-Arquitetura]] → [[Arquitetura-Tecnica]] → [[08-Diagrama-ER]]
```

### 👨‍💻 Você é **Desenvolvedor**?
```
Comece: [[07-Checklist]] → [[03-Banco-de-Dados]] → [[04-Filament-Resources]]
Consulte: [[Fluxo-Ordem-Servico]] (lógica) + [[Fluxo-Permissoes]] (segurança)
```

### 🧪 Você é **QA/Tester**?
```
Estude: [[DIAGRAMAS]] → [[Fluxo-Permissoes]] (matrix) → [[07-Checklist]] (testes)
```

### 🤔 Você é **PM/Product**?
```
Entenda: [[01-Requisitos]] → [[CANVAS]] → [[DIAGRAMAS]]
```
...
```
1. Estude: [[01-Requisitos]] + [[02-Arquitetura]]
2. Prepare: [[03-Banco-de-Dados]] (criar migrations)
3. Modele: [[08-Diagrama-ER]] (validar schema)
4. Buildar: [[04-Filament-Resources]] (CRUD)
5. Proteja: [[06-Permissões]] (RBAC)
6. Visualize: [[05-Dashboard]] (widgets)
7. Teste: [[07-Checklist]] (7 fases)
8. Implante: [[Arquitetura-Tecnica]] (deployment)
```
...
```
[[DIAGRAMAS]] → Encontre o fluxo → Clique no link
```

### 🏗️ Desenvolvimento
Enquanto codifica:
```
[[07-Checklist]] → Marque tarefas conforme progride
...
- Consulte **[[07-Checklist]]** enquanto implementa
